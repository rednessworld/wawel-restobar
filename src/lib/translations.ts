...
const dishes = {
  es: [
    { name: 'Pierogi', polish: 'Pierogi Ruskie', description: 'Dumplings caseros rellenos de queso fresco y patata, servidos con nata y cebolla caramelizada', price: '€9', photo: '/images/food1.jpg' },
    { name: 'Placki Ziemniaczane', polish: 'Placki', description: 'Tortitas de patata crujientes servidas con nata agria y salmón ahumado', price: '€8', photo: '/images/food2.jpg' },
    { name: 'Pollo Kiev', polish: 'Kotlet Kijowski', description: 'Pechuga de pollo rellena de mantequilla de hierbas, empanada y frita al punto', price: '€14', photo: '/images/food3.jpg' },
    { name: 'Bigos', polish: 'Bigos Myśliwski', description: 'Estofado tradicional de caza con chucrut, champiñones secos y especias ahumadas', price: '€11', photo: '/images/food6.jpg' },
    { name: 'Kiełbasa', polish: 'Kiełbasa z Grilla', description: 'Salchicha polaca a la brasa con mostaza antigua y pan de centeno casero', price: '€10', photo: '/images/food9.jpg' },
    { name: 'Szarlotka', polish: 'Szarlotka', description: 'Tarta de manzana polaca con canela, servida tibia con nata montada', price: '€5', photo: '/images/dessert1.jpg' },
  ] as Dish[],
  en: [
    { name: 'Pierogi', polish: 'Pierogi Ruskie', description: 'Homemade dumplings filled with fresh cheese and potato, served with cream and caramelised onion', price: '€9', photo: '/images/food1.jpg' },
    { name: 'Potato Pancakes', polish: 'Placki', description: 'Crispy potato pancakes served with sour cream and smoked salmon', price: '€8', photo: '/images/food2.jpg' },
    { name: 'Chicken Kiev', polish: 'Kotlet Kijowski', description: 'Chicken breast filled with herb butter, breaded and fried to perfection', price: '€14', photo: '/images/food3.jpg' },
    { name: 'Bigos', polish: 'Bigos Myśliwski', description: 'Traditional hunter\'s stew with sauerkraut, dried mushrooms and smoked spices', price: '€11', photo: '/images/food6.jpg' },
    { name: 'Kiełbasa', polish: 'Kiełbasa z Grilla', description: 'Grilled Polish sausage with whole-grain mustard and homemade rye bread', price: '€10', photo: '/images/food9.jpg' },
    { name: 'Szarlotka', polish: 'Szarlotka', description: 'Polish apple pie with cinnamon, served warm with whipped cream', price: '€5', photo: '/images/dessert1.jpg' },
  ] as Dish[],
  cat: [
    { name: 'Pierogi', polish: 'Pierogi Ruskie', description: 'Dumplings casolans farcits de formatge fresc i patata, servits amb nata i ceba caramel·litzada', price: '€9', photo: '/images/food1.jpg' },
    { name: 'Placki Ziemniaczane', polish: 'Placki', description: 'Creps de patata cruixents servits amb nata agra i salmó fumat', price: '€8', photo: '/images/food2.jpg' },
    { name: 'Pollastre Kíiv', polish: 'Kotlet Kijowski', description: 'Pit de pollastre farcit de mantequilla d\'herbes, arrebossat i fregit al punt', price: '€14', photo: '/images/food3.jpg' },
    { name: 'Bigos', polish: 'Bigos Myśliwski', description: 'Estofat tradicional de caça amb xucrut, bolets secs i espècies fumades', price: '€11', photo: '/images/food6.jpg' },
    { name: 'Kiełbasa', polish: 'Kiełbasa z Grilla', description: 'Salsitxa polonesa a la brasa amb mostassa antiga i pa de sègol casolà', price: '€10', photo: '/images/food9.jpg' },
    { name: 'Szarlotka', polish: 'Szarlotka', description: 'Pastís de poma polonès amb canyella, servit tebi amb nata muntada', price: '€5', photo: '/images/dessert1.jpg' },
  ] as Dish[],
};
