...
const translations = {
  es: {
    ...
    hero: {
      headline: 'El alma de Cracovia, en el corazón de Barcelona',
    ...
    reservations: {
      ...
      phoneHint: 'Toca para llamar',
      whatsappHint: 'Abrir WhatsApp',
    },
    testimonials: {
  ...
  en: {
    ...
    hero: {
      headline: 'The soul of Kraków, in the heart of Barcelona',
    ...
    reservations: {
      ...
      weekdayHours: '10:00 AM – 11:00 PM',
  ...
  cat: {
    ...
    hero: {
      headline: 'L\'ànima de Cracòvia, al cor de Barcelona',
    ...
    reservations: {
      ...
      phoneHint: 'Toca per trucar',
      whatsappHint: 'Obrir WhatsApp',
    },
    testimonials: {
  ...
  pl: {
    ...
    hero: {
      headline: 'Dusza Krakowa w sercu Barcelony',
      tagline: 'Smak Polski w sercu Barcelony',
      subtitle: 'Autentyczna kuchnia polska w Eixample',
      cta: 'Zarezerwuj stolik',
      scrollHint: 'Odkryj więcej',
    },
    about: {
      title: 'Nasza Historia',
      subtitle: 'Dusza Krakowa w Barcelonie',
      body1: 'Wawel bierze swoją nazwę od legendarnego zamku w Krakowie — serca Polski. W barcelońskiej dzielnicy Eixample, o krok od Sagrada Família, przynosimy autentyczne smaki polskiej kuchni: pierogi z ręki, bigos myśliwski i kiełbasę z grilla.',
      body2: 'Ciepły zakątek, gdzie każde danie opowiada rodzinną historię. Polskie piwo rzemieślnicze, przepisy przekazywane z pokolenia na pokolenie i gościnność Europy Północnej pod śródziemnomorskim słońcem.',
      badge: '4.7 ⭐ na Google · 514 opinii',
      cta: 'Zarezerwuj stolik',
    },
    menu: {
      title: 'Nasze Menu',
      subtitle: 'Kuchnia polska',
      touchToSee: 'Dotknij, aby zobaczyć',
      hoverToSee: 'Najedź myszką',
      dishes: dishes.es,
    },
    gallery: {
      title: 'Galeria',
      subtitle: 'Chwile w Wawel',
      videosTitle: 'Życie w Wawel',
      close: 'Zamknij',
    },
    reservations: {
      title: 'Rezerwacja',
      subtitle: 'Czekamy na Ciebie w Eixample',
      phoneLabel: 'Telefon',
      whatsappLabel: 'WhatsApp',
      phone: '+34 934 57 95 50',
      whatsapp: '+34 674 53 98 59',
      ...
      saturdayHours: '11:00 – 23:00',
      sundayHours: '11:00 – 20:00',
      groupsNote: 'Dla grup powyżej 8 osób prosimy o kontakt telefoniczny.',
      priceRange: 'Średnia cena: €10–20 za osobę',
      phoneHint: 'Zadzwoń',
      whatsappHint: 'Napisz na WhatsApp',
    },
    testimonials: {
      title: 'Co mówią nasi goście',
      subtitle: 'Prawdziwe opinie z Google',
      rating: '4.7',
      ratingLabel: 'na Google · 514 opinii',
      googleButton: 'Wszystkie opinie na Google',
      reviews,
    },
    location: {
      ...
      phone: '+34 934 57 95 50',
      instagram: '@wawelrestobar',
      nearSagrada: '2 minuty od Sagrada Família',
      transport: 'Metro: Verdaguer (L4/L5)',
      getDirections: 'Jak dojechać',
    },
    footer: {
      tagline: 'Smak Polski w Barcelonie',
      rights: 'Wszelkie prawa zastrzeżone',
      privacy: 'Prywatność',
      cookies: 'Cookies',
      madeWith: 'Zrobione z ❤️ w Barcelonie',
    },
  },
};
